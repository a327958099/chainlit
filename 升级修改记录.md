...
src/chainlit/frontend/src/components/socket.tsx # 在socket.on('new_message', (message: IMessage) =>监听消息的方法里添加广播代码
// 页面间消息广播
...
src/chainlit/frontend/src/components/organisms/chat/history/index.tsx # 添加获取URL参数的方法,在const submit = useCallback方法里添加消息广播
// 页面间消息广播
