...
src/chainlit/frontend/src/components/socket.tsx # 在socket.on('new_message', (message: IMessage) =>监听消息的方法里添加缓存消息内容
// 缓存消息内容
...
src/chainlit/frontend/src/components/organisms/chat/history/index.tsx # 添加获取URL参数的方法,在const submit = useCallback方法里缓存消息内容
// 缓存消息内容
